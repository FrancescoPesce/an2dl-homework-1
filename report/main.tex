...
\begin{document}
    ...
    \begin{center}
        ...
        {Codabench Nickname1,}
        {Codabench Nickname2,}
        {Codabench Nickname3,} %francescopesce
        {Codabench Nickname4}\\ 
        \vspace{2mm}
    ...
    \begin{multicols}{2}
        ...
        % This is literally bloat for the sake of losing everyone's time.
        ...
        \begin{enumerate}
            \item Dataset characteristics % 8 classes, 96x96 rgb images, labels, etc
            \item Main challenges % The test set is horrible
            \item Initial assumptions % That the test set was not horrible? Is this what they mean?
        \end{enumerate}
        ...
        % Step 5: testing residual networks (up to 0.8) and inception blocks (up to 0.72)
        ...
        % Failed experiments:
        % transfer learning (bad accuracy) (VGG, MobileNet, ResNet), both with and without fine tuning
